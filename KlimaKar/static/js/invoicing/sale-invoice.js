...
$(function() {
    ...
    $(".item-netto").change(function() {
        ...
        $(item_form)
            .find(".item-brutto")
            .val(String(price_brutto).replace(".", ","));
        $(item_form)
    ...
    $(".item-brutto").change(function() {
        ...
        $(item_form)
            .find(".item-netto")
            .val(String(price_netto).replace(".", ","));
        $(item_form)
            .find(".item-total-netto")
            .text(total_netto.toFixed(2).replace(".", ",") + " zł");
    ...
    $(".choose_service").click(function() {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $(item_form)
                    .find(".item-netto")
                    .val(result.service.price_netto);
                $(item_form)
                    .find(".item-brutto")
