$(function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                result.changes.forEach(function (change) {
                    const div_class = change.is_discount ? "success" : "danger";
                    const change_text = change.is_discount ? "Obniżka" : "Podwyżka";
                    const result_div =
                        `<div class="list-group-item list-group-item-action list-group-item-${div_class}">
    ...
    $('#prices-tab').on('show.bs.tab', function (e) {
