...
urlpatterns = [
    ...
    path('pobieranie-faktur', views.InvoiceDownloadSettingsUpdateView.as_view(), name='invoice_download'),
    ...
    path('mycloud_authorize/', views.MyCloudRedirectAuthorizeView.as_view(), name='mycloud_authorize'),
    path('mycloud_initialize', views.MyCloudHomeInitializeView.as_view(), name='mycloud_initialize'),
]
