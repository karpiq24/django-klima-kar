...
urlpatterns = [
    ...
    path('pobieranie-faktur', views.InvoiceDownloadSettingsUpdateView.as_view(),
    ...
    path('mycloud_authorize/', views.MyCloudRedirectAuthorizeView.as_view(),
         name='mycloud_authorize'),
    path('mycloud_initialize', views.MyCloudHomeInitializeView.as_view(),
