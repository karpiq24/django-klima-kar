...
urlpatterns = [
    ...
    path(
        "pojazdy/<str:slug>,<int:pk>",
        views.VehicleDetailView.as_view(),
        name="vehicle_detail",
    ),
    path(
        "pojazdy/<str:slug>,<int:pk>/edycja",
        views.VehicleUpdateView.as_view(),
        name="vehicle_update",
    ),
    path("pojazdy/nowy", views.VehicleCreateView.as_view(), name="vehicle_create"),
    path(
        "vehicle_autocomplete_create",
        views.VehicleAutocomplete.as_view(modal_create=True),
        name="vehicle_autocomplete_create",
    ),
    path(
        "vehicle_autocomplete",
        views.VehicleAutocomplete.as_view(),
        name="vehicle_autocomplete",
    ),
    path(
        "vehicles/<int:pk>/update_ajax",
        views.VehicleUpdateAjaxView.as_view(),
        name="vehicle_update_ajax",
    ),
    path(
        "vehicles/create_ajax",
    ...
    path(
        "podzespoly/<str:slug>,<int:pk>/edycja",
        views.ComponentUpdateView.as_view(),
        name="component_update",
    ),
    path(
        "podzespoly/nowy", views.ComponentCreateView.as_view(), name="component_create"
    ),
    path(
        "component_autocomplete_create",
        views.ComponentAutocomplete.as_view(modal_create=True),
        name="component_autocomplete_create",
    ),
    path(
    ...
    path(
        "components/<int:pk>/update_ajax",
        views.ComponentUpdateAjaxView.as_view(),
        name="component_update_ajax",
    ),
    path(
        "components/create_ajax",
        views.ComponentCreateAjaxView.as_view(),
        name="component_create_ajax",
    ),
    ...
    path(
        ...
        views.CommissionFileDownloadView.as_view(),
        name="commission_file_download",
    ),
    path(
        "<str:slug>,<int:pk>/edycja",
        views.CommissionUpdateView.as_view(),
        name="commission_update",
    ),
    path(
        "<str:slug>,<int:pk>.pdf",
        views.CommissionPDFView.as_view(),
        name="commission_pdf",
    ),
    path(
        "<str:slug>,<int:pk>.pdf/drukuj",
        views.CommissionPDFView.as_view(print_version=True),
        name="commission_print_pdf",
    ),
    path(
        "nowe/pojazd",
        views.CommissionCreateView.as_view(commission_type=Commission.VEHICLE),
        name="commission_create_vehicle",
    ),
    path(
        "nowe/podzespol",
        views.CommissionCreateView.as_view(commission_type=Commission.COMPONENT),
    ...
    path(
        ...
        name="prepare_invoice_url",
    ),
    path(
        "commission_email",
        views.CommissionSendEmailView.as_view(),
        name="commission_email",
    ),
    path(
        "fast_commission",
        views.FastCommissionCreateView.as_view(),
