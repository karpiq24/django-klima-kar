...
class VehicleTable(tables.Table):
    brand = tables.Column(attrs={"th": {"width": "24%"}})
    model = tables.Column(attrs={"th": {"width": "23%"}})
    registration_plate = tables.Column(attrs={"th": {"width": "23%"}})
    vin = tables.Column(attrs={"th": {"width": "23%"}})
...
class ComponentTable(tables.Table):
    component_type = tables.Column(attrs={"th": {"width": "24%"}})
    model = tables.Column(attrs={"th": {"width": "23%"}})
    serial_number = tables.Column(attrs={"th": {"width": "23%"}})
    catalog_number = tables.Column(attrs={"th": {"width": "23%"}})
    actions = tables.TemplateColumn(
        attrs={"th": {"width": "7%"}},
        verbose_name="Akcje",
...
class CommissionTable(tables.Table):
    pk = tables.Column(
        attrs={"th": {"width": "10%"}}, empty_values=(), verbose_name="Numer zlecenia"
    )
    vc_name = tables.Column(
        attrs={"th": {"width": "19%"}}, empty_values=(), verbose_name="Pojazd/podzespół"
    )
    contractor = tables.Column(attrs={"th": {"width": "17%"}})
    ...
    start_date = tables.Column(
        attrs={"th": {"width": "12%"}}, verbose_name="Data przyjęcia"
    )
    end_date = tables.Column(
        attrs={"th": {"width": "12%"}}, verbose_name="Data zamknięcia"
    )
    value = tables.Column(
