...
urlpatterns = [
    ...
    path('faktury/<str:slug>,<int:pk>', views.SaleInvoiceDetailView.as_view(), name='sale_invoice_detail'),
    path('faktury/nowa/<str:type>', views.SaleInvoiceCreateView.as_view(), name='sale_invoice_create'),
    path('faktury/nowa/<str:type>/zlecenie/<str:slug>,<int:pk>', views.SaleInvoiceCommissionCreateView.as_view(), name='sale_invoice_commission_create'),
    path('faktury/<str:slug>,<int:pk>/edycja', views.SaleInvoiceUpdateView.as_view(), name='sale_invoice_update'),
    path('faktury/korekta/<str:slug>,<int:pk>', views.CorrectiveSaleInvoiceCreateView.as_view(), name='sale_invoice_create_corrective'),
    path('faktury/<str:slug>,<int:pk>/edycja-korekty', views.CorrectiveSaleInvoiceUpdateView.as_view(), name='sale_invoice_update_corrective'),
    path('faktury/<str:slug>,<int:pk>.pdf', views.SaleInvoicePDFView.as_view(), name='sale_invoice_pdf'),
    path('faktury/<str:slug>,<int:pk>.pdf/drukuj', views.SaleInvoicePDFView.as_view(print_version=True), name='sale_invoice_print_pdf'),
    ...
    path('uslugi/<str:slug>,<int:pk>', views.ServiceTemplateDetailView.as_view(), name='service_template_detail'),
    path('uslugi/<str:slug>,<int:pk>/edycja', views.ServiceTemplateUpdateView.as_view(), name='service_template_update'),
    ...
    path('kontrahenci/<str:slug>,<int:pk>', views.ContractorDetailView.as_view(), name='contractor_detail'),
    path('kontrahenci/<str:slug>,<int:pk>/edycja', views.ContractorUpdateView.as_view(), name='contractor_update'),
