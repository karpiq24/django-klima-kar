...
class UserSessionTable(tables.Table):
    user = tables.Column(attrs={"th": {"width": "10%"}})
    user_agent = tables.Column(attrs={"th": {"width": "35%"}})
    client_ip = tables.Column(attrs={"th": {"width": "13%"}})
    country = tables.Column(attrs={"th": {"width": "12%"}})
    created = tables.Column(attrs={"th": {"width": "23%"}})
